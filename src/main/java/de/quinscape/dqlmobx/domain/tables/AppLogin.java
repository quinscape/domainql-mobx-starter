...
*/
package de.quinscape.dqlmobx.domain.tables;


import de.quinscape.dqlmobx.domain.Indexes;
import de.quinscape.dqlmobx.domain.Keys;
import de.quinscape.dqlmobx.domain.Public;
import de.quinscape.dqlmobx.domain.tables.records.AppLoginRecord;
...
public class AppLogin extends TableImpl<AppLoginRecord> {
    ...
    private static final long serialVersionUID = 528299684;
